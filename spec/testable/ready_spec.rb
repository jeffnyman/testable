RSpec.describe Testable::Ready do
  let(:test_interface) do
    Class.new do
      include Testable::Ready
  ...
  context "execution based on ready status" do
    ...
    #  }.to raise_error Testable::Errors::NoBlockForWhenReady
    # end
    ...
    it "indicates if any ready validation fails" do
      ...
      end.to raise_error(Testable::Errors::PageNotValidatedError, /NO REASON PROVIDED/)
    ...
    it "indicates if any ready validation fails with a specific error message" do
      ...
      end.to raise_error(Testable::Errors::PageNotValidatedError, /reason provided/)
    end
    ...
    it "indicates failure immediately on the first validation failure" do
      ...
      expect do
        test_interface.new.when_ready { puts 'testing' }
      end.to raise_error Testable::Errors::PageNotValidatedError
